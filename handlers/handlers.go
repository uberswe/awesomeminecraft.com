...
const BaseURL = "https://www.awesomeminecraft.com"
...
func (h *Handler) Home(w http.ResponseWriter, r *http.Request) {
	...
	data := HomeData{
		Meta: Meta{
			Title:        "Awesome Minecraft - Curated Minecraft Resources",
			Description:  fmt.Sprintf("A curated collection of %d+ Minecraft resources for players, builders, server admins, and developers.", h.Data.TotalResources),
...
func (h *Handler) Category(w http.ResponseWriter, r *http.Request) {
	...
	if description == "" {
		description = fmt.Sprintf("Browse %d %s resources for Minecraft including %s.", resourceCount, category.Name, subcatPreview)
	}

	data := CategoryData{
		Meta: Meta{
			Title:        fmt.Sprintf("%s - Awesome Minecraft", category.Name),
			Description:  description,
...
func (h *Handler) Search(w http.ResponseWriter, r *http.Request) {
	...
	title := "Search - Awesome Minecraft"
	description := "Search Minecraft resources including mods, plugins, tools, and more."
	if query != "" {
		title = fmt.Sprintf("Search: %s - Awesome Minecraft", query)
		description = fmt.Sprintf("Found %d Minecraft resources matching '%s'.", len(results), query)
	}
...
func (h *Handler) Resource(w http.ResponseWriter, r *http.Request) {
	...
	data := ResourceData{
		Meta: Meta{
			Title:        fmt.Sprintf("%s - %s | Awesome Minecraft", resource.Name, resource.CategoryName),
...
func (h *Handler) Privacy(w http.ResponseWriter, r *http.Request) {
	data := LegalData{
		Meta: Meta{
			Title:        "Privacy Policy - Awesome Minecraft",
			Description:  "Privacy Policy for Awesome Minecraft. Learn how we collect, use, and protect your information.",
...
func (h *Handler) Terms(w http.ResponseWriter, r *http.Request) {
	data := LegalData{
		Meta: Meta{
			Title:        "Terms and Conditions - Awesome Minecraft",
			Description:  "Terms and Conditions for using Awesome Minecraft. Please read carefully before using our site.",
